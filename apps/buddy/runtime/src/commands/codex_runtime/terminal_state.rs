...
use super::super::{
    run_state::{
        claim_buddy_run_terminal, is_buddy_run_cancelled, BuddyRunCancellationToken,
...
pub(super) fn claim_completion_or_abort_cancelled_run(
    storage: &BuddyStorage,
    run_id: &str,
    approval_id: Option<&str>,
    protocol: &str,
    ...
    if claim_buddy_run_terminal(cancellation) {
        return Ok(());
    }
