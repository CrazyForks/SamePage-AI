...
use crate::{choreography::registry::ActionRegistry, error::BuddyResult};
...
pub(super) fn native_pet_preset_behavior_execute_step_request(
    ...
    execute_step_request(
        ...
        ExecuteStepPayload::PlayAction {
            ...
            completion_behavior: SidecarPlayActionCompletionBehavior::RestoreIdle,
...
mod tests {
    ...
    use crate::{
        ...
        native_pet::{
            ...
            step_runtime::native_pet_advance_active_step,
        },
    };
